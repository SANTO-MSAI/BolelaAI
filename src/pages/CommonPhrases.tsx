...
const commonPhrases: Phrase[] = [
  ...
  { phrase: 'Ngicela amanzi', translation: 'Can I have water?' },
  { phrase: 'Siyakwamukela', translation: 'Welcome' },
...
const CommonPhrases = () => {
  ...
  const current = commonPhrases[currentIndex];
  ...
  const finished = currentIndex >= commonPhrases.length;

  return (
    <div className="max-w-xl mx-auto p-6 bg-white rounded-2xl shadow space-y-4">
      {!finished ? (
        <>
          <h2 className="text-2xl font-bold text-mzansi-purple">Translate this phrase:</h2>
        ...
        <div className="text-center">
          <h2 className="text-2xl font-bold text-green-600">🎉 You’ve completed the Common Phrases Module!</h2>

...
const responses: Phrase[] = [
  { phrase: 'Ngiyaphila', translation: 'I am fine' },
  { phrase: 'Ngiyabonga', translation: 'Thank you' },
  { phrase: 'Ngiyaxolisa', translation: 'I am sorry' },
  { phrase: 'Hamba kahle', translation: 'Go well' },
  { phrase: 'Siyabonga', translation: 'Thank you (plural)' },
];
...
const Responses = () => {
  ...
  const finished = currentIndex >= responses.length;

  return (
    <div className="max-w-xl mx-auto p-6 bg-white rounded-2xl shadow space-y-4">
      {!finished ? (
        <>
          <h2 className="text-2xl font-bold text-mzansi-purple">Translate this response:</h2>
        ...
        <div className="text-center">
          <h2 className="text-2xl font-bold text-green-600">🎉 You’ve completed the Responses Module!</h2>

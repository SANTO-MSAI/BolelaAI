...
const questions: Phrase[] = [
  { phrase: 'Ubani igama lakho?', translation: 'What is your name?' },
  { phrase: 'Uphi?', translation: 'Where are you from?' },
  { phrase: 'Uneminyaka emingaki?', translation: 'How old are you?' },
  { phrase: 'Kunjani?', translation: 'How are you?' },
  { phrase: 'Ukephi?', translation: 'Where is he/she?' },
];
...
const Questions = () => {
  ...
  return (
    <div className="max-w-xl mx-auto p-6 bg-white rounded-2xl shadow space-y-4">
      {!finished ? (
        <>
          <h2 className="text-2xl font-bold text-mzansi-purple">Translate this question:</h2>
        ...
        <div className="text-center">
          <h2 className="text-2xl font-bold text-green-600">🎉 You’ve completed the Questions Module!</h2>
